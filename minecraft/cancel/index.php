...
<body >
	...
	<div id="main-wrapper">
		...
		<div id="main">
			...
			<h1>El proceso de compra ha sido cancelado</h1>
			<h2>Si tienes dudas contactate con minecraft@colemono.com</h2>
			<a href="http://www.colemono.com/minecraft">Volver</a>
