	...
	<div id="main-wrapper">
		...
		<div id="main">
			...
			<div id="post">
				...
				<p class="post-meta">Published on <?php the_time( get_option('date_format') ); ?>, by <?php the_author(); ?> - Posted in <?php echo get_the_term_list( $post->ID, 'video_category', ' ',', ' ) ?> <span class="meta-comment"><a href="#respond"><?php comments_number('0', '1', '%' );?></a></span></p>
