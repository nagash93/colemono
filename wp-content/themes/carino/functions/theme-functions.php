...
function van_social_networks() {
	...
	<ul class="social-icons clearfix">
		<?php if( van_get_option('feed-url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('feed-url') ); ?>"  title="Rss"  target="_blank" ><span class="icon icon-rss"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('facebook_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('facebook_url') ); ?>" title="Facebook" target="_blank" ><span class="icon icon-facebook"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('twitter_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('twitter_url') ); ?>" title="Twitter" target="_blank" ><span class="icon icon-twitter"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('youtube_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('youtube_url') ); ?>" title="Youtube"  target="_blank"><span class="icon icon-youtube"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('g_plus_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('g_plus_url') ); ?>" title="Google +" target="_blank" ><span class="icon icon-gplus"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('dribbble_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('dribbble_url') ); ?>" title="Dribbble" target="_blank" ><span class="icon icon-dribbble"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('stumbleupon_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('stumbleupon_url') ); ?>" title="Stumbleupon" target="_blank" ><span class="icon icon-stumbleupon"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('tumblr_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('tumblr_url') ); ?>" title="Tumblr" target="_blank" ><span class="icon icon-tumblr"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('pinterest_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('pinterest_url') ); ?>" title="Pinterest" target="_blank" ><span class="icon icon-pinterest"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('flickr_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('flickr_url') ); ?>" title="Flickr" target="_blank" ><span class="icon icon-flickr"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('vimeo_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('vimeo_url') ); ?>" title="Vimeo" target="_blank" ><span class="icon icon-vimeo"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('instagram_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('instagram_url') ); ?>" title="Instagram"  target="_blank" ><span class="icon icon-instagramm"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('linkedin_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('linkedin_url') ); ?>" title="Linkedin" target="_blank" ><span class="icon icon-linkedin"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('behance_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('behance_url') ); ?>" title="Behance" target="_blank"><span class="icon icon-behance"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('skype_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('skype_url') ); ?>" title="Skype" target="_blank" ><span class="icon icon-skype"></span></a></li>
		<?php endif; ?>
		<?php if( van_get_option('github_url') ): ?>	
			<li><a href="<?php echo esc_url( van_get_option('github_url') ); ?>" title="Github" target="_blank" ><span class="icon icon-github"></span></a></li>
		<?php endif; ?>
	</ul>
	<?php 
}
...
function van_author_social( $user_id  = false ){
	...
	if ( get_the_author_meta( 'gplus', $user_id ) ){
		$social .= '<li><a class="tooltip" href="' . esc_url( get_the_author_meta('gplus' , $user_id) ) . '" title="' . esc_attr( get_the_author_meta('display_name' , $user_id) ) . ' ' . esc_attr__( 'on Google+', 'van' ) . '"><span class="icon-gplus"></span></a></li>';
	}
...
function van_comments( $comments_number = 3 ){
	...
	?>
	<div class="posts-widget" style="overflow: auto; height: 400px;">
		<ul>
			<?php foreach ( $comments as $comment ): ?>
				...
				<li class="clearfix">
					...
					<div class="entry-media skipover" style="width:48px;height:48px; margin-right: 10px;">
					...
					<div class="author-comment">
						<a href="<?php echo get_permalink($comment->comment_post_ID ); ?>#comment-<?php echo $comment->comment_ID; ?>">
							...
							<p style="word-wrap:break-word; font-size:12px;"><?php echo $comment_excerpt; ?></p>
						</a>
					</div>
				</li>
			<?php endforeach; ?>
...
function van_ribbon(){
	...
	if ( ( is_single() &&  van_get_option("single_format_icn") ) || ( !is_single() && van_get_option("format_icon")  )  ) {
		...
		if ( in_category('programas')){

		if ( in_category('rockygames')){$output .= '<span class="post-format-icon post-format-icon-rock"></span>';}
						
						elseif ( in_category('nota')){$output .= '<span class="post-format-icon post-format-icon-nota"></span>';} 

						elseif ( in_category('podcast-sin-hogar')){$output .= '<span class="post-format-icon post-format-icon-pod"></span>';} 
						elseif ( in_category('premios-colemono')){$output .= '<span class="post-format-icon post-format-icon-premio"></span>';} 
						elseif ( in_category('primera-impresion-programas')){$output .= '<span class="post-format-icon post-format-icon-pri"></span>';} 
						elseif ( in_category('ranking')){$output .= '<span class="post-format-icon post-format-icon-rank"></span>';} 
						elseif ( in_category('resumen-semanal-programas')){$output .= '<span class="post-format-icon post-format-icon-res"></span>';} 
						elseif ( in_category('columnas')){$output .= '<span class="post-format-icon post-format-icon-colum"></span>';} 
						elseif ( in_category('colemono-tv')){$output .= '<span class="post-format-icon post-format-icon-tv"></span>';} 
						elseif ( in_category('cuarto-de-maquinas')){$output .= '<span class="post-format-icon post-format-icon-tuerca"></span>';} 	
						elseif ( in_category('unboxing')){$output .= '<span class="post-format-icon post-format-icon-box"></span>';} 						
						elseif ( in_category('vs')){$output .= '<span class="post-format-icon post-format-icon-vs"></span>';} 
						elseif ( in_category('E3 2014')){$output .= '<span class="post-format-icon post-format-icon-e3"></span>';} 
						elseif ( in_category('reviews')){$output .= '<span class="post-format-icon post-format-icon-review"></span>';} 
						elseif ( in_category('festigame')){$output .= '<span class="post-format-icon post-format-icon-fest"></span>';} 
	...
	if( is_single() ) { 
		...
		if ( van_get_option('display_content')  !== "none" || $format == "status" ) {
			...
			if (  van_get_option('display_content')  == "full" || $format == "status" ) {
				...
				the_content(__( 'Leer más &rarr;', 'van' ));
...
function van_social_share() {
	...
	<div class="article-share clearfix">
		...
		<?php if ( van_get_option("fb_button") ): ?>
			<a href="javascript:;" class="icon-facebook" onclick="vanOpenUrl('<?php echo $facebook; ?>')" class="tooltip share-btn" title="<?php esc_attr_e('Facebook','van'); ?>"> <span>Facebook</span></a>
		<?php endif; ?>

		<?php if ( van_get_option("tweet_button") ): ?>
			<a href="javascript:;" class="icon-twitter" onclick="vanOpenUrl('<?php echo $twitter; ?>')" class="tooltip share-btn" title="<?php esc_attr_e('Twitter','van'); ?>"> <span>Twitter</span></a>
		<?php endif; ?>
