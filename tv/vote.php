...
<body <?php body_class(); ?> <?php if((in_category('E3 2013')&is_singular())||is_category('E3 2013')){  echo  'id="e3"';}?>>
	...
	<div id="main-wrapper">
		...
		<div id="main">
<div id="debate_1_2172470"><div class="os-power-by" style="max-width:620px;width:100%;margin-top:2px;line-height:11px;text-align:left;font-family: Arial, Helvetica, sans-serif;font-size:11px;">
  <div>
    <a href="http://www.opinionstage.com/?o=poll" target="_blank" rel="nofollow" style="color:#8A8A8A !important;text-decoration:none">online poll by <em style="color:#33b5e5 !important">Opinion Stage</em></a>
  </div>
</div>
</div>
<script>
  (function () {
    ...
    opst.async = true;
    opst.src = os_host + '//' + 'www.opinionstage.com/debates/2172470/embed.js';
